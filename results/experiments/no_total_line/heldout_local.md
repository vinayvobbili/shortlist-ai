...
| h02_daniel_okoye | sre_kubernetes (1, score 57) | 1 | 1.00 |
...
**43/44 agree** · 0 too lenient · 1 too strict
...
| Expected verdicts agreeing (of 44) | 39.0 | 40.7 | 43.0 |
| ... too lenient | 0.0 | 1.3 | 2.0 |
| ... too strict | 1.0 | 2.0 | 3.0 |

- **138 of 147 requirement verdicts (94%) were identical in every ordering.**
- A (job, resume) score moved by 2.1 points on average across orderings, and at most 13.4 (h02_daniel_okoye for sre_kubernetes).
...
| azure_security_engineer | h06_ryan_brooks | `azure_security` | partial → partial → met |
...
| sre_kubernetes | h02_daniel_okoye | `kubernetes_production` | partial → not_met → not_met |
| sre_kubernetes | h02_daniel_okoye | `observability` | not_met → partial → not_met |
| sre_kubernetes | h05_hana_kowalski | `observability` | partial → not_met → not_met |
...
| 3 | h02_daniel_okoye | 57 | 1 |
| 4 | h05_hana_kowalski | 33 | 0 |
| 5 | h03_sofia_marino | 30 | 0 |
| 6 | h04_chloe_bennett | 20 | 0 |
